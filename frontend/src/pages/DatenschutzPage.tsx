...
export function DatenschutzPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <h1 className="font-display text-3xl text-plum-deep">Datenschutzerklärung</h1>
        ...
        <div className="bg-white rounded-lg shadow p-8 space-y-6 text-ink-soft text-sm leading-relaxed">
          ...
          {/* Überblick */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">2. Überblick über die Datenverarbeitung</h2>
            <p>
          ...
          {/* Erhobene Daten */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">3. Welche Daten wir erheben</h2>

            <h3 className="font-semibold text-ink mt-4 mb-1">Organisator-Konto</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">Event-Teilnehmer</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">Spieledaten</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">Server-Logs</h3>
            <p>
          ...
          {/* Lokale Speicherung */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">4. Lokale Speicherung (localStorage)</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">5. Echtzeit-Verbindungen (SSE)</h2>
            <p>
          ...
          {/* Drittanbieter */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">6. Drittanbieter-Dienste</h2>

            <h3 className="font-semibold text-ink mt-4 mb-1">Google Analytics</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">Mixpanel</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">BoardGameGeek (BGG)</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink mt-4 mb-1">Buy Me a Coffee</h3>
            <p>
          ...
          {/* Hosting */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">7. Hosting</h2>
            <p>
          ...
          {/* Rechte */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">8. Deine Rechte</h2>
            ...
            <p className="mt-2">
              ...
              <a href="mailto:daniel@kreuzhofer.de" className="text-plum hover:underline">daniel@kreuzhofer.de</a>
            </p>
            <p className="mt-2">
          ...
          {/* Änderungen */}
          <section>
            <h2 className="text-lg font-semibold text-ink mb-2">9. Änderungen</h2>
            <p>
